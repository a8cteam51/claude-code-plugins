...
4. **Fix at the right ladder rung.** Adjust block supports/`theme.json` first; reach for a block style variation next; custom behaviour (`custom-blocks-guide.md`) only for behaviour; documented custom CSS last. Re-validate any changed markup.
